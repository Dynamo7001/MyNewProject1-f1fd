[MyNewProject1-f1fd] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [MyNewProject1-f1fd] container is NOT running**.

.. tip::
   You must have your [MyNewProject1-f1fd] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33959  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Dynamo7001'  \-\-env DOCKERUSERNAME='hooluwole'  \-\-env MQTTUSERNAME='hammed'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 59145:59145 -p 35063:35063 -p 33577:33577 \-\-env TSS=0 \-\-env SOLUTIONNAME=MyNewProject1-f1fd \-\-env SOLUTIONDAG=solution_preprocessing_dag-MyNewProject1-f1fd \-\-env GITUSERNAME=Dynamo7001  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi \-\-env SOLUTIONEXTERNALPORT=59145  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=35063  \-\-env SOLUTIONVIPERVIZPORT=33577 \-\-env DOCKERUSERNAME='hooluwole'  \-\-env EXTERNALPORT=33959 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hammed' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole/MyNewProject1-f1fd-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=33577
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=59145
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hooluwole/MyNewProject1-f1fd-amd64
...
It can be accessed by entering: http://localhost:35063
...
.. important::
   http://localhost:33577/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33577/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:33577/<html file>
...
[MyNewProject1-f1fd] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Dynamo7001/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/MyNewProject1-f1fd
...
.. important::
   solution_preprocessing_dag-MyNewProject1-f1fd
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=59145, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38087, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43085, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44973, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41373, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45743, HPDEHOST=127.0.1.1, HPDEPORT=43203, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45939

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-537-MyNewProject1-f1fd,solution_preprocessing_dag-MyNewProject1-f1fd, python-preprocess-5412-MyNewProject1-f1fd,solution_preprocessing_dag-MyNewProject1-f1fd, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
